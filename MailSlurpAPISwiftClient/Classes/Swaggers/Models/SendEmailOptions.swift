...
public struct SendEmailOptions: Codable {

    public enum SendStrategy: String, Codable { 
    ...
    public var templateVariables: JSONValue?
    ...
    public init(attachments: [String]?, bcc: [String]?, body: String?, cc: [String]?, charset: String?, from: String?, isHTML: Bool?, replyTo: String?, sendStrategy: SendStrategy?, subject: String?, template: UUID?, templateVariables: JSONValue?, to: [String]?, toContacts: [UUID]?, toGroup: UUID?) {
